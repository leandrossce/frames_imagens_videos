...
for image_file in image_files:
    try:
        ...
        # Redimensionar proporcionalmente para manter o conteúdo
        resized_image = resize_proportionally(image, target_size)

        # Recortar a partir do centro
        cropped_image = crop_center(resized_image, target_size)
